...
AGENT_RUNTIME_WEB_SEARCH_PROVIDER="${AGENT_RUNTIME_WEB_SEARCH_PROVIDER:-tavily}"
...
helm_args=(
  ...
  --set "webhook.publicBaseUrl=${AGENT_WEBHOOK_PUBLIC_BASE_URL}"
  --set "webhook.publicBaseUrlSecretName="
