...
kubectl -n "$namespace" rollout status deployment/aws-csa-customer-service-app --timeout=10m
kubectl -n "$namespace" rollout status deployment/aws-csa-customer-service-web --timeout=10m
